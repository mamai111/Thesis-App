...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<String> carouselImages = [
    "assets/images/urine_img.jpg",
    "assets/images/urine.jpg",
    "assets/images/urine_img.jpg",
  ];
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _referenceItem(
                          "Chen, Y., Zhang, X., & Liu, J. (2020). Artificial intelligence in urine analysis: A review of computer vision applications. Journal of Medical Systems, 44(😎.",
